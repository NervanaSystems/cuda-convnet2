...
#
# * Added width parameters for weights, activations, deltas, and so forth
# ----------------------------------------------------------------------------
...
#        self.dic['conserveMem'] = mcp.convnet.op.get_value('conserve_mem') if mcp.convnet is not None else 0
    ...
    def init(self, dic):
        self.dic = dic
        self.dic['deltaWidth']  = [32,32,32,-32,0]
        self.dic['weightWidth'] = [32,32,32,-32,0]
        self.dic['biasWidth']   = [32,32,32,-32,0]
        self.dic['actWidth']    = [32,32,32,-32,0]
        self.dic['gradWidth']    = [32,32,32,-32,0]
        return self
    ...
    def parse(self, name, mcp, prev_layers, model=None):
        ...
        self.dic['actWidth'] = mcp.safe_get_int_list(name, 'actWidth', default=[32,32,32,-32,0])
        self.dic['gradWidth'] = mcp.safe_get_int_list(name, 'gradWidth', default=[32,32,32,-32,0])
...
class WeightLayerParser(LayerWithInputParser):
    ...
    def add_params(self, mcp):
        ...
        dic['constMatrixStd'] = mcp.safe_get_float(name, 'constMatrixStd', default=0.0)
        ...
        dic['deltaWidth'] = mcp.safe_get_int_list(name, 'deltaWidth', default=[32,32,32,-32,0])
        dic['weightWidth'] = mcp.safe_get_int_list(name, 'weightWidth', default=[32,32,32,-32,0])
        dic['biasWidth'] = mcp.safe_get_int_list(name, 'biasWidth', default=[32,32,32,-32,0])
        dic['actWidth'] = mcp.safe_get_int_list(name, 'actWidth', default=[32,32,32,-32,0])
        dic['gradWidth'] = mcp.safe_get_int_list(name, 'gradWidth', default=[32,32,32,-32,0])
