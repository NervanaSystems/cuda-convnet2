...
#
# * added ability to save filters to disk
# ----------------------------------------------------------------------------
...
#        print self.test_outputs
    ...
    def make_filter_fig(self, filters, filter_start, fignum, _title, num_filters, combine_chans, FILTERS_PER_ROW=16):
        ...
        if not combine_chans:
            ...
            ax.imshow(bigpic, interpolation='nearest')
            pl.savefig(self.save_figure)
...
#        filters = filters / filters.max()
        if layer['type'] == 'fc': # Fully-connected layer
            ...
            if layer['type'] == 'local':
                ...
                # show only 1 of the 16 feature maps. 
...
#        print self.show_cost
    ...
    def get_options_parser(cls):
        ...
        op.add_option("save_figure", "save_figure", StringOptionParser, "Output file to save filters", default="")
